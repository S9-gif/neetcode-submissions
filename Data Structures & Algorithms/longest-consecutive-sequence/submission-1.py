...
Verilen karmaşık sayı dizisi için en uzun ardışık sayıların uzunluğunu istedi benden yani kaç
 tane sayı bu listede ardışık gidebiliyor? Bunun cevabını aradık.
 Bunun için yukarıda bahsettiğim gibi elindeki listeyi sort ile
 sıralayıp tekrarlayan liste elemanlarından kurtulmak için set() kullandım. Daha sonra for
 Döngüsü ile bu ideal listemde gezindim ve her eleman için "bu elemanın bir fazlası var mı?"
 Şeklinde sordum eğer var ise bunları bir sayaç ile saydım bulunamıyorsa ve şu ana kadarki 
 bulunan en uzunsa bu uzunluğu sakladım ve bütün dizide bunu yaptım bütün diziyi taradıktan sonra da
 En son saklanan uzunluğu çıktı olarak verdim
