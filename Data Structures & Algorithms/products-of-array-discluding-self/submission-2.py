...
Topic'ler arasında prefix sum görünce konuyu araştırdım ve toplama işlemi için birikimli listelerde 
sıfır listesinin üzerine eklemelerin yapıldığını gördüm.Bu problem çarpma olduğu için etkisiz eleman
1 olacaktur bu nedenle [1,1,1,1] şeklinde bir liste oluşturdum sonra sınırı parçalamam gerekliydi
bunun için de iki farklı sınırı liste halinde kullandım .Gerisi çarpımı yerleştirmekteydi.
